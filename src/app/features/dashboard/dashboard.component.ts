...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  totalEquipment: number = 320;
  activeMaintenanceTasks: number = 124;
  activeMaintenanceProgress: number = 78;
  openDefects: number = 47;
  criticalDefects: number = 12;
  majorDefects: number = 18;
  minorDefects: number = 17;
  equipmentFitProgress: number = 95;
  equipmentFitSystemsCount: string = '304/320 systems';
  taskCompletionRate: number = 88;
  overdueTasks: number = 8;
  ...
  kpiMetrics = [
    ...
    },
    {
      ...
      titleColor: '#E53935',
      valueColor: '#E53935',
      severityDetails: { critical: 12, major: 18, minor: 17 }
    },
    {
